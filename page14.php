...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        if ($insertSql->execute()) {
            ...
            echo '        if("' . $_POST['savepoint_number'] . '" === "15") {';
            echo '            window.location.href = "page15.html";';
            echo '        } else {';
...
<head>
    ...
    <title>Crime Game - Page 14</title>
    <style>
        body {
...
<body>
    ...
    <input type="hidden" id="savepoint_number" name="savepoint_number" value="15"> <!-- Set default savepoint_number -->
</form>
...
<form id="save-form-option-B-D" style="display: none;" method="POST">
    ...
    <script>
        ...
        if (option === 'A') {
            ...
            saveToDatabase('page8.jpg', 'page15', 'Amidst an eerie PUP campus, a perplexing crime baffles investigators.', 15);

            // Redirect to page15.html
